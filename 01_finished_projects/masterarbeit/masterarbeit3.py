...
for idx,product in enumerate(products):
    ...
    df_temp=df_in.loc[(df_in!=0).any(axis=1),df_in.columns[-1]]
    
    
    
    df_last_value.append(df_temp.iloc[-1])
...
#checkout_time=df_in.iloc[-1][-1]



df_check['Taktzeit']=28000/df_check["Ist-Schicht-Stückzahlen"]
